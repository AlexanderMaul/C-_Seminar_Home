...
// Комментарий преподавателя - По задаче 4 - решение рабочее, но не оптимальное. Избыточные сравнения.
// Если num_A уже сравили в первом условии с другими числами, то в следующих условиях его не нужно сранивать.